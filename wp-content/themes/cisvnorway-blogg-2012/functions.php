...
// MAKE SIDEBAR USABLE FOR WIDGETS
if ( function_exists('register_sidebars') ) {
    register_sidebars(4, array(
    							'before_widget'=>'<div class="widget-1">',
    							'description'   => 'Sidebar 1 er kalender, 2 er twitter, 3 er tags, 4 er velkomsttekst',
    							'after_widget'=>'</div>',
    							'before_title'=>'<h2>',
    							'after_title'=>'</h2>'
...
$args = array(
	'width'         => 960,
	'height'        => 300,
	'default-image' => get_template_directory_uri() . '/images/front-image-blog.jpg',
	'uploads'       => true,
);
...
add_image_size( 'nyhetssaker-thumb', 250, 250, true );
}
