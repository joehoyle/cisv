		...
		<div id="kontainer">
			...
			<div id="topp-wrapper">
				...
				<div id="topp-meta">
					...
					<div id="sok">
					 <a href="#" class="show"><img src="http://www.cisv.no/wp-content/themes/cisvnorway_TEST2012/images/ikon-sok-av.png" /></a>
						<a href="#" class="hide" title="Lukk søkeboksen">Lukk</a>
						<form id="searchform" method="get" action="<?php bloginfo('home'); ?>">
        					<p><input type="text" name="s" id="searchbox" value=""/>
        					<input name="S&oslash;k" type="image" value="<?php esc_attr_e('S&oslash;k'); ?>" src="http://www.cisv.no/wp-content/themes/cisvnorway_TEST2012/images/ikon-sok-aktiv.png" id="searchbutton"/></p>
						</form>
					</div>
				</div>
			</div>
			...
			<div id="hoved-wrapper">
				<?php if ( is_home() ) { ?>
				<div id="slider-felt" class="blogger">
					<div class="hovedsak">
