...
Donate link: http://www.nexwp.com
...
1. For 0.25+, make sure the folder '/wp-content/' is dir createable and writable, as the cache folder will be '/wp-content/widget-cache'; For the older version, make sure the subfolder 'cache' of this plugin, usually folder '/wp-content/plugins/wp-widget-cache/cache' is writable
...
Here's a list of such widgets to be finished, if you know something new, just visit [here](http://www.nexwp.com/stories/wp-widget-cache-for-wordpress), and leave a comment.
