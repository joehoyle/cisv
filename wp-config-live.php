...
define( 'WPCACHEHOME', '/home/virtual/no.cisv.org/htdocs/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
...
define('VHOST', 'no'); 
$base = '/';
define('DOMAIN_CURRENT_SITE', 'cisv.no' );
...
define( 'NONCE_SALT', '|fvSz<x1qtG fur{h*hX46SX@}!E]i[~idX:>VT@K4lw*Qs/=!@-S,J~bzlmPpE`' );
